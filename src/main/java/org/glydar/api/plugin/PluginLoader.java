...
public class PluginLoader {
    ...
    private Map<String, URL> jarMap = new HashMap<>();

    public static final String PLUGINS_FOLDER = "plugins";
    public static final String PLUGIN_PROPERTIES = "plugin.properties";

    public void loadPlugins() {
        File pluginDir = new File(PLUGINS_FOLDER);
        if (!pluginDir.exists()) {
            pluginDir.mkdirs();
            return;
        }
    ...
    private Plugin getPlugin(File file) throws PluginException, NoSuchMethodException, SecurityException, IOException,
        ...
        try {
            InputStream is = cl.getResourceAsStream(PLUGIN_PROPERTIES);
    ...
    public void enablePlugin(Plugin plugin) {
        try {
            ...
            Glydar.getServer().getLogger().warning("Error enabling plugin: " + e.getStackTrace());
        }
